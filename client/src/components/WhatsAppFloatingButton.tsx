    ...
    <div className="fixed bottom-5 right-4 z-[80] sm:bottom-6 sm:right-6">
      <div className="whatsapp-bounce">
        <a
          ...
          className="group relative inline-flex items-center gap-3 rounded-full border border-cyan-300/70 bg-gradient-to-r from-violet-500 via-indigo-500 to-sky-500 px-3 py-2 pr-4 text-white shadow-[0_16px_38px_-16px_rgba(37,99,235,0.9)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_45px_-16px_rgba(37,99,235,1)]"
        >
          <span className="relative inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] shadow-[0_10px_20px_-10px_rgba(37,211,102,0.9)] ring-2 ring-white/85">
            <svg
              viewBox="0 0 16 16"
              aria-hidden="true"
          ...
          <span className="hidden pr-1 text-[18px] font-semibold leading-none sm:inline">
            Chat with Propy
          </span>
        </a>
      </div>
