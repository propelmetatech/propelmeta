...
export default function OnlineSales() {
  ...
  return (
    <Layout>
      <section className="relative overflow-hidden pt-16 pb-10 min-h-[640px] bg-gradient-to-br from-orange-50 via-white to-red-50/30 sm:pb-12 lg:min-h-[600px]">
        {/* Hero Section */}
        <ServiceHeroBanner />
      ...
      <section className="py-12 bg-gradient-to-br from-slate-50 to-orange-50/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="font-bold font-display mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
      ...
      {/* Benefits Section */}
      <section className="py-12 bg-gradient-to-br from-orange-50 to-red-50/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            <motion.div
              initial={{ opacity: 0, x: -20 }}
