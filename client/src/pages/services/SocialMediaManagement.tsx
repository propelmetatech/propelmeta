...
export default function SocialMediaManagement() {
  ...
  return (
    <Layout>
      <section className="relative overflow-hidden pt-20 pb-16 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center rounded-full border border-blue-200/50 bg-white/80 px-4 py-2 text-sm font-medium text-blue-600 mb-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/pricing">
              <Button
                size="lg"
                variant="secondary"
                className="text-lg px-8 py-6 rounded-xl bg-white text-blue-700"
              >
                Start Free Trial
              </Button>
            </Link>
