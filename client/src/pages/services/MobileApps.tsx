            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link href="/demo">
                  <Button
                    size="lg"
                    className="text-lg px-8 py-6 rounded-xl shadow-xl shadow-pink-500/25 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700"
                  >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/demo">
                <Button
                  size="lg"
                  variant="secondary"
                  className="text-lg px-8 py-6 rounded-xl bg-white text-pink-700 hover:bg-pink-50"
                >
                  <Download className="h-5 w-5 mr-2" />
                  Start Building
                </Button>
