...
export default function WebsiteBuilder() {
  ...
  return (
    <Layout>
      <section className="relative overflow-hidden pt-16 pb-10 min-h-[640px] bg-gradient-to-br from-blue-50 via-white to-purple-50/30 sm:pb-12 lg:min-h-[600px]">
        ...
        <div className="mx-auto lg:ml-[35px] max-w-7xl px-4 pr-12 sm:px-6 sm:pr-6 lg:px-8 lg:pr-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[500px]">
            ...
            <motion.div
              ...
              className="lg:col-span-5 w-full max-w-[640px] rounded-2xl bg-slate-900/30 px-4 py-7 backdrop-blur-[2px] sm:px-6 sm:py-8 lg:max-w-none lg:bg-transparent lg:px-0 lg:py-8 lg:pl-[30px] lg:pr-0 lg:-ml-10 lg:mr-6 lg:backdrop-blur-0"
            >
